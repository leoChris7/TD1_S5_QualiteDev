...
namespace GestionProduit_API.Migrations
{
    ...
    [Migration("20241007062330_ProduitDB1")]
    partial class ProduitDB1
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GestionProduit_API.Models.EntityFramework.Produit", b =>
                {
                    b.HasOne("GestionProduit_API.Models.EntityFramework.Marque", "Marque")
                        .WithMany("Produits")
                        .HasForeignKey("IdMarque")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_pdt_mrq");

                    b.HasOne("GestionProduit_API.Models.EntityFramework.TypeProduit", "TypeProduit")
                        .WithMany("Produits")
